    ...
    <Card
      ...
      title={
        <div
          ...
          <ConversionControlsComponent />
        </div>
      }>
      {
        <div
          className="h-full relative lineage-container"
          data-testid="conversion-container"
          id="conversion-container" // ID is required for export PNG functionality
...
export default ConversionLineage;
