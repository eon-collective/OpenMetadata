...
} from './ConversionProvider.interface';

export const ConversionContext = createContext({} as ConversionContextType);

const ConversionProvider = ({ children }: ConversionProviderProps) => {
        ...
        addLineageHandler(newEdgeWithoutFqn)
          .then(() => {
            ...
            const { edges: createdEdges, columnsHavingLineage } =
              createEdgesAndEdgeMaps(allNodes, allEdges, entityFqn, false);
  ...
  return (
    <ConversionContext.Provider value={activityFeedContextValues}>
      <div
...
export const useConversionProvider = () => useContext(ConversionContext);
